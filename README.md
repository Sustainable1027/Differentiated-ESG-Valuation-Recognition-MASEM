...
Across all validation procedures, the core asymmetric valuation structure remains substantively stable: governance maintains the strongest positive association with firm market valuation, environmental performance exhibits a negative average association, and social performance does not display consistent independent pricing power once cross-dimensional correlations are modeled.
